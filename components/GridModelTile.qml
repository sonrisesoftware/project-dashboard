...
Item {
    ...
    property alias noneText: noneItem.text
    ...
    UbuntuShape {
        ...
        Column {
            ...
            ListView {
                ...
                width: parent.width
                height: maxHeight === -1 ? listView.contentHeight : Math.min(maxHeight - titleItem.height - tile.anchors.margins, listView.contentHeight)
